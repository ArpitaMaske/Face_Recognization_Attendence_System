...
class Developer:
    def __init__(self, root):
        ...
        img_top = Image.open(r"C:\Users\Arpita\Desktop\Face Recognization Attendence System\Images\14.jpeg")
        ...
        img_top1 = Image.open(r"C:\Users\Arpita\Desktop\Face Recognization Attendence System\Images\13.jpg")
        ...
        Dev_lbl = Label(main_frame, text=" Hello My name is Arpita ",
                          font=("times new roman", 20, "bold"), bg="white", fg="black")
        Dev_lbl.place(x=0, y=5)

        Dev_lbl = Label(main_frame, text=" I am 2nd Year Student ",
                        font=("times new roman", 20, "bold"), bg="white", fg="black")
